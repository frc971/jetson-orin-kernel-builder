...
sudo cp kernel-devicetree/generic-dts/dtbs/tegra234-p3767-camera-p3768-imx296-imx296.dtbo /boot/
...
# gst-launch-1.0 nvarguscamerasrc sensor-id=1  aelock=true exposuretimerange="100000 200000"  gainrange="1 15"  ispdigitalgainrange="1 1" ! 'video/x-raw(memory:NVMM), width=(int)1456, height=(int)1088, framerate=(fraction)60/1, format=(string)NV12' ! nveglglessink -e
